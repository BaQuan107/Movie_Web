...
<html lang="en">
    ...
    <body>
        ...
        <script>
             function pay() {
              window.location.href = "/Movie_Web/main/vnpay/vnpay_pay.jsp";
            }
            function querydr() {
              window.location.href = "/Movie_Web/main/vnpay/vnpay_querydr.jsp";
            }
             function refund() {
              window.location.href = "/Movie_Web/main/vnpay/vnpay_refund.jsp";
            }
        </script>
    </body>
</html>
